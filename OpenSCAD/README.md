...
| ファイル | 向き | 特徴 |
| :--- | :--- | :--- |
| **`Plates/Plate_A1mini_Corne36_Tipped.stl`**(推奨) | **上向きから70°傾ける** | **36キー一括。天面に積層痕が出ず、かつ典型オーバーハングが寝かせ(66°)より小さい約47°。152×91mm** |
...
**上向きから70°傾けるのを推奨します。** 壁にぺたりと寝かせる(90°)のは一見よさそうですが、
接地パッチからキャップ全幅まで断面が広がる分をわずか1〜2mmの高さで消化するため、
典型オーバーハングが約66°に達し、外周がカールしてノズルに当たります。
70°まで起こすと同じ広がりをずっと長い高さに分散でき、**典型オーバーハングは約47°**まで下がります。
レイヤーはディッシュを斜めに横切るので、天面の積層痕も出ません。
最適値は65〜75°と幅があり、オリジナルKLP Laméの推奨と一致します。

上向き(底面を下)が最も安定しますが、天面に同心円状の積層痕が出ます。
