...
| ファイル | 向き | 特徴 |
| :--- | :--- | :--- |
| **`Plates/Plate_A1mini_Corne36_Tipped.stl`**(推奨) | **上向きから45°傾ける** | **36キー一括・サポート不要。外側で45°を超える面はわずか17mm²。天面の積層痕も出ません。154×112mm** |
...
45°なら見える面はほぼ全て自立します。レイヤーはディッシュを45°で横切るので
ステップ幅は約0.08mmで、上向き印刷の同心円状の積層痕とは比較になりません。
オリジナルKLP Laméの推奨角度でもあります。

- ノズル: 0.4 mm / レイヤー: 0.08–0.12 mm
- 壁: 4 以上、インフィル: 100%(小さい部品なのでほぼ変わりません)
- 向き: 45°傾け(推奨)。**サポート不要**。ブリムは3mm程度
